let
  ...
  keys.personal.skoll = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIE1vy9Xan494NtFMgAOrUgWxc1iaoTZgvQfvPVw6avfu abechanko@utilidata.com";
in
{
  "gemini_api_key.age" = {
    publicKeys = [
